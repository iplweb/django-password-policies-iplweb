...
# Imported after django.setup(): the package pulls in models, which cannot be
# loaded before the app registry is ready.
...
copyright = "2012, Tarak Blah; 2017-2026, Michał Pasternak"
